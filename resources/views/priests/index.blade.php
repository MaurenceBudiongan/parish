            ...
            @empty
                <div class="col-12 text-center py-5">
                    <div class="empty-state">
                        <i class="fas fa-user-priest fa-4x mb-3 text-muted"></i>
                        <h4>No Priest Profiles Found</h4>
                        <p class="text-muted">Click "Add New Priest" to create your first priest profile.</p>
                    </div>
                </div>
            @endforelse
        </div>
