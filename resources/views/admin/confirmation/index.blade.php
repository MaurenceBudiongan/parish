        ...
        <div class="certificate">
            ...
            <div class="mid">
                ...
                <p>
                    ...
                    <br>
                    <span class="date"> the
                        <input class="day" type="text" name="day" value="{{ $confirmation->day }}" readonly>
                        of
                        <input class="month" type="text" name="month" value="{{ $confirmation->month }}"
                            readonly>,
                        <input class="year" type="number" name="year" value="{{ $confirmation->year }}" readonly>
                        by this Excellency
                    </span>
                    <input class="excellency" type="text" name="excellency" value="{{ $confirmation->excellency }}"
                        readonly>.D., Archibishop/Bishop of
