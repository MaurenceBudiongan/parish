    ...
    <div class="certificate">
        ...
        <div class="mid">
            ...
            <p>
                ...
                Date of Birth <span class="semi2">:</span> <input class="date_birth" type="text" name="date_birth">
                Place of Birth <span class="semi3">:</span> <input class="place" type="text" name="place">
                Name of Father <span class="semi4">:</span> <input class="mother_name" type="text"
                    name="mother_name">
                ...
                Date Of Baptism&nbsp;&nbsp;&nbsp;&nbsp;: <input class="date_baptism" type="text" name="date_baptism">
