...
<head>
    ...
    <style>
        ...
        .certificate { border: 7px solid #555; padding: 20px; width: 700px; margin: auto; }
        .top, .mid, .bottom { text-align: center; }
        .top p { font-size: 12px; margin: 0; }
        .mid h1 { font-size: 24px; margin-bottom: 20px; }
        .mid p { font-size: 14px; text-align: justify; }
        .bottom p { font-size: 12px; margin-top: 40px; }
    </style>
</head>
<body>
    <div class="certificate">
        ...
        <div class="mid">
            ...
            <p>
                ...
                Name of Spouse (if married) or Name of Parents if minor or single: <strong>{{ $death->guardian }}</strong><br>
                ...
                <strong>{{ $death->day }}</strong> day of <strong>{{ $death->month }}</strong>, <strong>{{ $death->year }}</strong>
