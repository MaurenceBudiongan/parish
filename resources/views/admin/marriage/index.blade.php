<div class="certification">
    @forelse ($marriages as $marriage)
        <form action="{{ route('marriages.destroy', $marriage->id) }}" method="POST">
            ...
            <div class="certificate">
                ...
                <div class="mid">
                    ...
                    <p>
                        ...
                        <span class="witnessed">
                            ...
                            <span class="witnessed-content">
                                ...
                                <input type="text" name="seventh_witnessed"
                                    value="{{ $marriage->seventh_witnessed }}" readonly>
                        ...
                        <input class="place" type="text" name="place_issuance"
                            value="{{ $marriage->place_issuance }}" readonly>
                        on
            ...
            <div class="buttons">
                ...
                <a href="{{ route('marriages.download', $marriage->id) }}">
    ...
    @empty
        <tr>
            <td colspan="8">No marriage certification record found.</td>
        </tr>
    @endforelse
</div>
